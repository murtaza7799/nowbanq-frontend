  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active NowBanq Profile to buy Minting Tickets and mint a NowBanq Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold NWB'),
      bodyText: [t('Each NFT costs NWB to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      bodyText: [
        ...
        `04:00 UTC, Oct. 7 ${t(
          'Pre-sale: Wallets which held “Gen 0” NowBanq Bunnies NFTs (bunnyID 0,1,2,3,4) at a snapshot taken some time between 12 and 2 hours before the presale begins can purchase one Squad Ticket per Gen 0 NFT.',
        )}`,
        `08:00 UTC, Oct. 7 ${t(
    ...
    },
    {
      ...
      title: t('Claim Phase'),
      bodyText: [
        t('During this phase, any wallet holding a Squad Ticket can redeem their ticket to claim a NowBanq Squad NFT.'),
      ],
      buttons: (
        <>
          {hasData && (

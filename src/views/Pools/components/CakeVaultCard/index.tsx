  ...
  const { tooltip, tooltipVisible, targetRef } = useTooltip(
    hasEndBlockOver ? (
      <>
        ...
        <LinkExternal href="https://twitter.com/NowBanq">
      ...
      <>
        <Text>
          {t(
            'The start block of the current calculation period. Your average IFO NowBnaq Pool staking balance is calculated throughout this period.',
          )}
        </Text>
        <LinkExternal href="https://medium.com/NowBanq/initial-farm-offering-ifo-3-0-ifo-staking-pool-622d8bd356f1">

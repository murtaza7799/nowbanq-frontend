  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on NowBanq.'),
      ],
    },
    {
      ...
      description: [
        t(
          'Soon! The current NFT Market is a basic version (phase 1), with early access to trading NowBanq NFTs .',
        ),
    ...
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by NowBanq from sales are used to buy back and BURN NWB tokens in our weekly NWBburns.',
        ),
        t(
